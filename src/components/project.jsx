    ...
    <div id="Project" className=" bg-gray-500 bg-opacity-30 md:m-10 max-w-full mb-5">
        ...
        <div>
            <div className=" sm:grid grid-cols-2 gap-4 p-5">
                ...
                shadow-md overflow-hidden hover:animate-pulse md:max-w-2xl bg-pink-400 bg-opacity-30 ">
                ...
                <div className="max-w-sm mx-auto  rounded-xl 
                shadow-md overflow-hidden hover:animate-pulse md:max-w-2xl mt-2 sm:mt-0 bg-pink-400 bg-opacity-30">
            ...
            <div className="sm:grid grid-cols-2 gap-4 p-5">
                ...
                <div className="max-w-sm mx-auto  rounded-xl 
                shadow-2xl overflow-hidden hover:animate-pulse md:max-w-2xl mt-2 sm:mt-0 bg-pink-400 bg-opacity-30">
                <div className="md:flex "> 
                    <div className="p-8"> 
                        <div className="uppercase tracking-wide to-indigo-500 
